...
>> Plain webpack 4 boilerplate with Babel, TypeScript, SASS and Jest on board
...
```sh
$ curl -L -o master.zip https://github.com/mwilber/webpack-boilerplate/archive/gz-typescript.zip && unzip master.zip && rm master.zip && mv -n ./webpack-boilerplate-gz-typescript/{.,}* ./ && rm -r ./webpack-boilerplate-gz-typescript
```
